                ...
                </div>
                {
                  ...
                  <div>
                    <div className=' flex flex-row h-12'>
                      <button className="text-red-600 border-red-500 border-2 transition transform hover:scale-110 px-4 py-0 my-2 mx-4 rounded-full" onClick={(event)=>DeleteStudent(event,_id)}> Delete </button>
                    </div>
                  </div>
                }
